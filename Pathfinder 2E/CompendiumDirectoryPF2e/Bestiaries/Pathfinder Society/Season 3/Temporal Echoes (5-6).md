...
attacks:
  ...
  - name: "Temporal Shudder"
    desc: "`pf2:2` (occult) The temporal echo screams, causing time to shudder and bend around it. All creatures in a @Template[emanation|distance:10] take 5d6 mental damage (DC 18 Will check save). Creatures that fail the saving throw are also [[Conditions/Slowed|Slowed 1]] for 1 round. The echo can't use Temporal Shudder again for 1d4 rounds."
