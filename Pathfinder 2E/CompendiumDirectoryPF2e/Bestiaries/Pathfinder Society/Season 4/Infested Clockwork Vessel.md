...
attacks:
  ...
  - name: "Etheric Discharge"
    desc: "`pf2:2` (divine) The controlled clockwork vessel releases arcs of void energy from the essence-gatherer on its back. Creatures within a @Template[emanation|distance:10] take 9d6 void damage (DC 23 Fortitude check). The vessel can't use Etheric Discharge for 1d4 rounds."
