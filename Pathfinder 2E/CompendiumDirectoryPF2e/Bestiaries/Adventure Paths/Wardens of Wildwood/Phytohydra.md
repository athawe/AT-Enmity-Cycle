...
attacks:
  ...
  - name: "Melee"
    desc: "`pf2:1` Branch +25 (reach 10 feet)\n__Damage__  4d6 + 11 bludgeoning plus push"

  - name: "Melee"
    desc: "`pf2:1` Fangs +25 (reach 10 feet)\n__Damage__  4d6 + 13 piercing"
  ...
  - name: "Splinter Breath"
    desc: "`pf2:2`  The phytohydra spews splinters in a @Template[cone|distance:60] that deals 4d6 piercing damage to all creatures in the area (DC 32 Reflex check save). The damage increases by 2d6 for each head the phytohydra has.\n\nThe phytohydra can't use Splinter Breath again for 1d4 rounds."
