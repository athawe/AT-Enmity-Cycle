...
abilities_mid:
  ...
  - name: "Explode"
    desc: "  When the alchemical golem is reduced to 0 Hit Points, it explodes and deals damage from its alchemical rupture ability in a @Template[emanation|distance:10]. If a critical hit reduced the golem to 0 Hit Points, creatures in the area treat their saving throws against the rupture effects as one degree worse."
