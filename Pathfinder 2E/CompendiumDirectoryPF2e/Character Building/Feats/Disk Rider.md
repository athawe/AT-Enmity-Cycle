...
* * *
When you cast [[Spells/Floating Disk|Floating Disk]], you can modify its duration to be sustained, up to 10 minutes. If you do, add the following heightened entry to its effects.
