...
attacks:
  ...
  - name: "Seiya! Soiya!"
    desc: "`pf2:2` (emotion,mental,sonic) The night parade shouts a series of energetic call-and-responses, dealing 3d10 sonic damage and 4d6 mental damage to all creatures in a @Template[burst|distance:10] within 20 feet (DC 41 Will check save). If the troop is reduced to 8 or fewer squares, this area decreases to a @Template[burst|distance:5]."
