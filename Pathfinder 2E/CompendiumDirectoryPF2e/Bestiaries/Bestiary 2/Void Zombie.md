...
attacks:
  ...
  - name: "Feed on Blood"
    desc: "`pf2:1`  **Requirements** The void zombie's previous action was a successful feeding tendril Strike against the target creature\n* * *\n\n**Effect** The void zombie uses its feeding tendril to drain blood from the creature struck. The void zombie regains 4 Hit Points, and the creature is [[Conditions/Drained|Drained 1]] until it receives healing of any kind or amount."
