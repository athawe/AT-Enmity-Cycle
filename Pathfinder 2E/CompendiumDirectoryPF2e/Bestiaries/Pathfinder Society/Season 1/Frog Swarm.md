...
attacks:
  ...
  - name: "Distraction"
    desc: "`pf2:2`  Any living creature within the area of a frog swarm must attempt a DC 12 Will check save. Humanoids that fail this save are [[Conditions/Stunned|Stunned 1]] ([[Conditions/Stunned|Stunned 2]] on a critical failure). Animals are [[Conditions/Frightened|Frightened 1]] on a successful save, [[Conditions/Frightened|Frightened 2]] and [[Conditions/Fleeing|Fleeing]] on a failure, and [[Conditions/Frightened|Frightened 3]] and fleeing on a critical failure."
