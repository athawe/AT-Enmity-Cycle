...
attacks:
  ...
  - name: "No Prey, No Pay"
    desc: "`pf2:r` **Trigger** The demon ark hits another ship and Encounter A begins\n* * *\n\n**Effect** The demon ark fires grapples at the Snapdragon. Each PC must attempt a DC 22 Reflex check save or be [[Conditions/Grabbed|Grabbed]] ([[/act escape dc=22]]); on a critical failure, they're also impaled and take 2d8+7 piercing damage. The demon ark then rolls initiative."
