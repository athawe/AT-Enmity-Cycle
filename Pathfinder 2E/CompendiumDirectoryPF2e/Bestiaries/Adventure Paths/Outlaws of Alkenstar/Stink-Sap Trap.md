...
attacks:
  ...
  - name: "Sudden Spray"
    desc: "`pf2:r` **Trigger** A creature or object weighing at least 50 pounds is placed on one of the flagstones north of the gate (marked \"T\" on the map)\n* * *\n\n**Effect** Pressurized sap sprays from the nozzle, coating everything in a @Template[cone|distance:15]. Creatures in the area that fail a DC 20 Reflex check save become affected by stink sap."
