...
attacks:
  ...
  - name: "Vent"
    desc: "`pf2:1` (fire) The golem vents a @Template[cone|distance:30] of superheated steam from its internal forge. This deals 15d6 fire damage to all creatures in the cone (DC 40 Reflex check).\n\nThe golem can't use Vent again for 1d6 rounds."
