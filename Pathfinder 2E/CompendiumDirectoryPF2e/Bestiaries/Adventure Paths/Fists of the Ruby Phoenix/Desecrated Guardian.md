...
attacks:
  ...
  - name: "Avalanche"
    desc: "`pf2:2`  The desecrated guardian thrashes its body about, causing the nearby terrain to crumble and crash down on creatures in a @Template[cone|distance:60], dealing 12d10 bludgeoning damage (DC 42 Reflex check save). It can't use Avalanche again for 1d4 rounds."
