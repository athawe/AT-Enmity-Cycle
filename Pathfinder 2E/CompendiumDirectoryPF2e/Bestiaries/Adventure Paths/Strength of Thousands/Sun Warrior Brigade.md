...
attacks:
  ...
  - name: "Walkena's Radiance"
    desc: "`pf2:2` (divine,fire,light) The brigade calls upon Walkena to burn and blind their foes. The sun warriors present their religious symbols and create a white-hot flash of light in a @Template[cone|distance:45]. Creatures in the cone take 10d8 fire damage (DC 29 Fortitude check save). Creatures that fail their save become [[Conditions/Dazzled|Dazzled]] for 1 round. Creatures that critically fail become [[Conditions/Blinded|Blinded]] for 1 round instead. When the troop is reduced to 8 or fewer squares, this area decreases to a @Template[cone|distance:20]."
